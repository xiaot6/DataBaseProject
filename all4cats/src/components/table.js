...
const columns = [
  { id: 'StateName', label: 'State Name', minWidth: 100 },
    { id: 'StateAbbreviations', label: 'State Abbreviations', minWidth: 80 },
    { id: 'StateSizeRank', label: 'State Size Rank', minWidth: 80 },
];
